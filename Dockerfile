...
RUN ckan-pip3 install --no-cache-dir -U pip && \
  ckan-pip3 install --no-cache-dir \
       ...
       -e git+https://github.com/ckan/ckanext-spatial.git@smellman-dev-py3#egg=ckanext-spatial \
       #-e git+https://github.com/ckan/ckanext-harvest.git@v1.3.1#egg=ckanext-harvest \
       -e git+https://github.com/ioos/catalog-ckan.git@py3_porting#egg=ckanext-ioos-theme \
